...
function Home() { 
    ...
    return (
        <div className="h-72 ds:h-96 bg-white w-full">
            <div className="pr-12 pl-12 ds:pr-48 ds:pl-48">
                <div className="pt-8">
                    <div className="flex flex-col ds:flex-row ds:items-end ds:justify-between">
                    ...
                    <div className="pt-6 flex flex-col ds:flex-row ds:justify-between h-96">
